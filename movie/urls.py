...
from .views import home,getMovie,about,help,contact,reviewPost,deleteReview,replyPost,seeReplies,addLove,showRatedlist,showTranding,catagoryFilter,topmovies
...
urlpatterns = [
    ...
    path('top-movies/', topmovies, name='topMovies'),
